...
This repo was generated from the excellent [elastdocker](https://github.com/sherifabdlnaby/elastdocker), with the settings changed to default the stack to HTTP at to be put behind a SSL load balancer.
